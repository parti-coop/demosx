...
public class S_9_8_관리자는_의견을_블럭_처리할_수_있다 {
    ...
    public void T_1_관리자는_제안의견을_블럭할_수_있다() {
        ...
        Opinion opinion = opinionService.blockOpinion(proposalOpinionId);
    ...
    public void T_2_관리자는_토론_찬성의견을_블럭할_수_있다() {
        Opinion opinion = opinionService.blockOpinion(yesOpinionId);
    ...
    public void T_3_관리자는_토론_반대의견을_블럭할_수_있다() {
        Opinion opinion = opinionService.blockOpinion(noOpinionId);
    ...
    public void T_4_관리자는_토론_기타의견을_블럭할_수_있다() {
        Opinion opinion = opinionService.blockOpinion(etcOpinionId);
    ...
    public void T_5_매니저는_제안의견을_블럭할_수_없다() {
        opinionService.blockOpinion(proposalOpinionId);
    }
