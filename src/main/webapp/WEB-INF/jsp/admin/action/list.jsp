...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>실행 관리
        <a href="<c:url value="/admin/issue/action-new.do"/>"
           class="btn btn-primary btn-sm pull-right">실행 생성하기
        </a>
      </h1>
    </section>
    ...
    var table = $('#list')
      ...
      .DataTable({
        ...
        columns: [
          ...
          {
            data: function (item) {
              return '<a href="/admin/issue/action-detail.do?id=' + item.id + '">' + item.title + '</a>';
            }, orderable: false
          },
