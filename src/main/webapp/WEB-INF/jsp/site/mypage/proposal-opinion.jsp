...
<div class="container">
    ...
    <form>
      <div class="sorting-tab__select">
        <select class="form-control" name="mypage-link">
          ...
          <option value="#" selected>나의 의견 활동</option>
        </select>
      </div>
    </form>
  </div>
  <ul class="my-page-tabs clearfix">
    ...
    <li class="my-page-tab active"><a href="<c:url value="/mypage/opinion.do"/>" class="my-page-tab__link">나의 의견 활동</a></li>
  </ul>
  ...
  <div class="clearfix">
    <div class="demo-content">
      ...
      <div class="block-board-wrapper">
        <div class="block-board-th">
          <div class="demo-th demo-th--block hidden-xs">
            <p class="">제목 / 의견</p>
          </div>
        </div>
        <ul class="block-list-ul">
          <c:forEach var="opinion" items="${opinions.content}">
            <li class="block-list-li">
              ...
              <div class="reply-wrapper">
                ...
                <ul class="my-sugest-ul">
                  <li class="my-sugest-li">
                    <p class="my-sugest-li__title">${opinion.contentWithBr()}</p>
