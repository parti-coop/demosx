...
<div class="discussion-comment-form" id="discussion-comment-form">
  <div class="demo-comment-form clearfix">
    ...
    <form>
      <textarea class="form-control demo-comment-textarea" rows="5" placeholder="로그인 후 댓글을 달 수 있습니다." disabled></textarea>
      <div class="comment-action-group row">
        <div class="comment-count col-xs-6">
...
<div class="demo-comments-container">
  ...
  <div class="show-more-container text-center">
    <button class="white-btn d-btn btn-more" type="button"  id="opinion-more">더보기<i class="xi-angle-down-min"></i></button>
  </div>
  ...
  $(function () {
    ...
    function makeOpinionString(opinion) {
      ...
      return '<li class="comment-li">' +
        ...
        '            <p class="comment-time"><i class="xi-time"></i> ' + opinion.createdDate + '</p>' +
        '          </div>' +
